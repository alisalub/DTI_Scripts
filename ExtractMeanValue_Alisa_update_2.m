...
P_value_nii=load_nii('F:\MSC\AlisaScansDTI\AlisaScriptsDTI\analysis\PBmask_ttest.nii'); %H:\AlisaScansDTI\Pablo_smothhed_for_statistics\PBanova1FA_ttest.nii %load Anova image
...
save_nii(Nii, 'AlanovaMD_ttest_cluster10.nii');
 
%%
 
 
% load atlas template and images
nii_Mice_clust_FA = load_untouch_nii('F:\MSC\AlisaScansDTI\AlisaScriptsDTI\analysis\AlanovaFA_ttest_cluster10.nii'); %H:\AlisaScansDTI\Pablo_smothhed_for_statistics\PBanova1FA_ttest_cluster10.nii
img_Mice_clust_FA = nii_Mice_clust_FA.img;
nii_Mice_clust_MD = load_untouch_nii('F:\MSC\AlisaScansDTI\AlisaScriptsDTI\analysis\AlanovaMD_ttest_cluster10.nii'); %H:\AlisaScansDTI\Pablo_smothhed_for_statistics\PBanova1_ttest_cluster10.nii
img_Mice_clust_MD = nii_Mice_clust_MD.img;
 
 
%Organize all the Images 
path=('C:\Users\user\Desktop\Alisa\Smoothed'); %H:\AlisaScansDTI\Pablo_smothhed_for_statistics\Smoothed % Insert the path of the MD scans
...
columns_titles = {'Subject','clustnum', 'Scan1', 'Scan2', 'Scan3', 'Scan4','Scan5','Scan6','%change2-1' ,'%change3-2' ,'%change4-3','%change5-4','%change6-5','%change6-1'};
