...
P_value_nii=load_nii('C:\Users\user\Desktop\Alisa\PBanova1_ttest.nii'); %H:\AlisaScansDTI\Pablo_smothhed_for_statistics\PBanova1FA_ttest.nii %load Anova image
...
save_nii(Nii, 'PBanova1_ttest_cluster10.nii');
 
%%
 
 
% load atlas template and images
nii_Mice_clust_FA = load_untouch_nii('C:\Users\user\Desktop\Alisa\PBanova1FA_ttest_cluster10.nii'); %H:\AlisaScansDTI\Pablo_smothhed_for_statistics\PBanova1FA_ttest_cluster10.nii
img_Mice_clust_FA = nii_Mice_clust_FA.img;
nii_Mice_clust_MD = load_untouch_nii('C:\Users\user\Desktop\Alisa\PBanova1_ttest_cluster10.nii'); %H:\AlisaScansDTI\Pablo_smothhed_for_statistics\PBanova1_ttest_cluster10.nii
