close all
cluster_nii = load_untouch_nii('WT_VS_KO_16mice_p_main_Between_WTvsKO_MD_FDR_MDcluster10.nii');
fa_nii = load_untouch_nii('Mean_FA.nii');
...
text(-110, -80,['ClusterNumber_' num2str(cluster)],'HorizontalAlignment','center','VerticalAlignment', 'top')

 temp=['cluster_' ,num2str(cluster),'_','Between_MD.png']; 
 saveas(gca,temp)
drawnow
