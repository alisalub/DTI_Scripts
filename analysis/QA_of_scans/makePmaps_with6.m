...
niifile1=sprintf('%s.nii', niifile.fileprefix);
...
if (numGaus==6)
    niifile1=sprintf('%s_p1.nii', niifile.fileprefix);
    im.img=32768*p1./(p1+p2+p3+p4+p5+p6);
    save_untouch_nii(im,niifile1);
    niifile1=sprintf('%s_p2.nii', niifile.fileprefix);
    
    im.img=32768*p2./(p1+p2+p3+p4+p5+p6);
    save_untouch_nii(im,niifile1);
    niifile1=sprintf('%s_p3.nii', niifile.fileprefix);
    
    im.img=32768*(p3)./(p1+p2+p3+p4+p5+p6);
    save_untouch_nii(im,niifile1);
    niifile1=sprintf('%s_p4.nii', niifile.fileprefix);
    
    im.img=32768*p4./(p1+p2+p3+p4+p5+p6);
    save_untouch_nii(im,niifile1);
    niifile1=sprintf('%s_p5.nii', niifile.fileprefix);
    
    im.img=32768*(p5)./(p1+p2+p3+p4+p5+p6);
    save_untouch_nii(im,niifile1);
    niifile1=sprintf('%s_p6.nii', niifile.fileprefix);
