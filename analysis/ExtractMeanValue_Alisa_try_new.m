...
P_value_nii=load_nii('/Volumes/SAMSUNG 1/MSc_PhD/DTI_Analysis/smoothed_allscans/stat_mask_3000/WT_VS_KO_16mice_p_main_Within_scan1_5_FA_FDR.nii');  %load Anova image
...
columns_titles = {'Subject','clustnum', 'Scan1', 'Scan2', 'Scan3', 'Scan4','Scan5'}; %'%change2-1' ,'%change3-2' ,'%change4-3','%change5-4','%change5-1', 'Scan1-std', 'Scan2-std', 'Scan3-std', 'Scan4-std','Scan5-std'
...
columns_titles_res = {'Group','clustnum', 'Scan1', 'Scan2', 'Scan3', 'Scan4','Scan5'}; 
...
P_value_nii=load_nii('/Volumes/SAMSUNG 1/MSc_PhD/DTI_Analysis/smoothed_allscans/stat_mask_3000/WT_VS_KO_16mice_p_main_Within_scan1_5_MD_FDR.nii'); %H:\AlisaScansDTI\Pablo_smothhed_for_statistics\PBanova1FA_ttest.nii %load Anova image
P_val_name=P_value_nii.fileprefix;
P_value_img=P_value_nii.img;
voxel_size=[P_value_nii.hdr.dime.pixdim(2),P_value_nii.hdr.dime.pixdim(3),P_value_nii.hdr.dime.pixdim(4)];
