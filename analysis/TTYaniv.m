...
Working_Path='F:\Aliens\Pablo_smothhed_for_statistics';



load_name=Names{1};
full_path_name=strcat(Working_Path,'\Sub_swPB',load_name,'_nii_regularized_MD_C_native_DWIs_MD_C_trafo_FA.nii') ;
...
nii2=load_untouch_nii('PBmask.nii');
mask=nii2.img;
...
%                    'd4','d4','d4','d4','d4','d4','d4','d4', 'd4', 'd4', 'd4', 'd4'};   
                ...
                groups = {'s1', 's1', 's1', 's1','s1', 's1', 's2', 's2', 's2', 's2', 's2', 's2', 's3', 's3', 's3', 's3', 's3', 's3','s4', 's4', 's4', 's4', 's4', 's4' };
