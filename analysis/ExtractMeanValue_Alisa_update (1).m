...
P_value_nii=load_nii('H:\MSC\AlisaScansDTI\AlisaScriptsDTI\analysis\AL_anova_meanMD.nii'); %H:\AlisaScansDTI\Pablo_smothhed_for_statistics\PBanova1FA_ttest.nii %load Anova image
